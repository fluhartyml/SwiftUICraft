...
enum UnderTheHoodContent {
    static let mainAppFiles: [DeveloperFile] = [
        .init(path: "SwiftUICraftApp.swift",
              description: "@main entry. Builds the SwiftData ModelContainer for Subject + Routine + LogEntry and hands ContentView to the WindowGroup."),
        ...
        .init(path: "Today/TodayView.swift",
              description: "Today's overview. All subjects' applicable scheduled routines + ad-hoc logs, sorted by time. + Log button opens QuickLogSheet. Top-left info button opens About."),
        ...
        .init(path: "Today/QuickLogSheet.swift",
              description: "Ad-hoc + Log path. Subject picker, freeform event name, when timestamp, notes, photo. Saves a LogEntry with sourceRoutineID = nil."),
